        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-white border-b border-slate-200">
              <tr>
                <th className="text-left font-semibold text-slate-700 px-3 py-2 w-28">Length</th>
                <th className="text-left font-semibold text-slate-700 px-3 py-2 w-28">Width</th>
                <th className="text-left font-semibold text-slate-700 px-3 py-2 w-20">Qty</th>
                <th className="text-left font-semibold text-slate-700 px-3 py-2 w-32">Material</th>
                <th className="text-left font-semibold text-slate-700 px-3 py-2 w-32">Label</th>
